...
const Profile = ({ getProfileByIDAction, match, profile:{ profile, loading }, auth}) => {
...
Profile.propTypes = {
    getProfileByIDAction: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { getProfileByIDAction })(Profile);
